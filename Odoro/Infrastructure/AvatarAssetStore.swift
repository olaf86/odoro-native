...
struct AvatarAssetStore {
    ...
    private static func makeGeneratedRigProfile(
        ...
        appendBinding(aliases: ["leftupperarm", "leftarm", "luparm"], canonicalJoint: .leftElbow, parentAliases: ["leftshoulder", "lshoulder"], parentJoint: .leftShoulder)
        appendBinding(aliases: ["rightupperarm", "rightarm", "ruparm"], canonicalJoint: .rightElbow, parentAliases: ["rightshoulder", "rshoulder"], parentJoint: .rightShoulder)
        appendBinding(aliases: ["leftlowerarm", "leftforearm", "llowarm"], canonicalJoint: .leftWrist, parentAliases: ["leftupperarm", "leftarm", "luparm"], parentJoint: .leftElbow)
        appendBinding(aliases: ["rightlowerarm", "rightforearm", "rlowarm"], canonicalJoint: .rightWrist, parentAliases: ["rightupperarm", "rightarm", "ruparm"], parentJoint: .rightElbow)
        appendBinding(aliases: ["lefthand"], canonicalJoint: .leftWrist, parentAliases: ["leftlowerarm", "leftforearm", "llowarm"], parentJoint: .leftWrist)
        appendBinding(aliases: ["righthand"], canonicalJoint: .rightWrist, parentAliases: ["rightlowerarm", "rightforearm", "rlowarm"], parentJoint: .rightWrist)
        appendBinding(aliases: ["leftupperleg", "leftupleg", "leftthigh"], canonicalJoint: .leftHip, parentAliases: ["hips", "pelvis"], parentJoint: .root)
        appendBinding(aliases: ["rightupperleg", "rightupleg", "rightthigh"], canonicalJoint: .rightHip, parentAliases: ["hips", "pelvis"], parentJoint: .root)
        appendBinding(aliases: ["leftlowerleg", "leftleg", "leftcalf"], canonicalJoint: .leftKnee, parentAliases: ["leftupperleg", "leftupleg", "leftthigh"], parentJoint: .leftHip)
        appendBinding(aliases: ["rightlowerleg", "rightleg", "rightcalf"], canonicalJoint: .rightKnee, parentAliases: ["rightupperleg", "rightupleg", "rightthigh"], parentJoint: .rightHip)
        appendBinding(aliases: ["leftfoot", "leftankle"], canonicalJoint: .leftFoot, parentAliases: ["leftlowerleg", "leftleg", "leftcalf"], parentJoint: .leftKnee)
        appendBinding(aliases: ["rightfoot", "rightankle"], canonicalJoint: .rightFoot, parentAliases: ["rightlowerleg", "rightleg", "rightcalf"], parentJoint: .rightKnee)
